...
import net.iblankdigital.auto.base.PushNotifySpec
import net.iblankdigital.auto.db.api.DetectFishing
import net.iblankdigital.auto.ext.*
...
object AutoTuyetTheTienDe : AutoBase() {

    val TAG = "AutoTuyetTheTienDe"
